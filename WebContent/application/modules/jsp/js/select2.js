...
(function ($, undefined) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        opening: function () {
            ...
            if (this.opts.minimumResultsForSearch >= 0) {
            	this.showSearch(this.opts.isShowSearch);
            }
    ...
    $.fn.select2 = function () {
        ...
        //2014年5月6日14:35:43，解决，select2不能兼容Validation Engine必选问题（主要解决保存时隐藏的必选项会出现多余的红框）
		$("select[class*='validate[required]']").removeClass("validate[required]");
