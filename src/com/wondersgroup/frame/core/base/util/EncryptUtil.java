...
public class EncryptUtil {
    ...
    public static void main(String[] args) throws Exception {
        //String a = "{zjhm:'37067777',rdT:'"+System.currentTimeMillis()+"'}";
        //String a = "{zjhm:'37067777',rdT:'11112334567'}";
        //String b = EncryptUtil.encrypt(a);
        //String c = URLEncoder.encode(b, "UTF-8");
        //String d = URLDecoder.decode(c, "UTF-8");
        //String e = EncryptUtil.decrypt(d);
        ...
        String t = "2dVkC30oDWylHex5tiJL5 DKr/Ecmn8O8y5Lq8ut0ODybd/FR3SQGGG7QzHyr6UJlx9eVoTEbFhC\n\rqw29MXbv1A==";

        System.out.println(EncryptUtil.decrypt(t));
